...
def find_camera_index(name_substring: str, occurrence: int = 0) -> int | None:
    """Returns the /dev/videoN for the occurrence-th (0-indexed) device whose
    v4l2-ctl name contains name_substring, or None if fewer than
    occurrence + 1 such devices exist/v4l2-ctl unavailable."""
    try:
